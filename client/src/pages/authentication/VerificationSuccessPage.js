    ...
    return (
        <div className="flex justify-center items-center h-screen" style={{
            ...
            <div className="p-8 rounded-lg w-[500px] bg-black border border-gray-300">
                <h2 className="text-center font-bold text-3xl mb-8 text-gray-300">{t('emailVerified')}</h2>
                <p className="text-center font-bold text-xl mb-8 text-green-500">{t('emailVerifiedSuccess')}</p>
                <Button
                    text={t('goToLogin')}
